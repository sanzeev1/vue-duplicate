<template>
    <div>
        <header class="header-area header-hm9">
                        ...
                        <div class="col-lg-5 col-8">
                            <div class="header-right-wrap">
                                <div class="same-style header-search d-none d-lg-block">
                                    <button class="search-active" @click="isOpenSearch = !isOpenSearch"><i
                                ...
                                <div class="same-style account-setting d-none d-lg-block">
                                    <button class="account-setting-active"
                                        @click="isOpenAccountSettings = !isOpenAccountSettings"><i
            ...
            <div class="header-padding-1 sticky-bar header-res-padding clearfix d-none d-lg-block"
