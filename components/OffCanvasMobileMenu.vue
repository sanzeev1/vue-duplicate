        ...
        <div class="mobile-menu-inner">
            ...
            <div class="mobile-menu-inner-wrapper">
                <div class="offcanvas-mobile-search">
                    <form v-on:submit="search" class="mobile-search-inner">
                        <input v-on:change="setSearch" type="text" placeholder="Search here">
                    ...
                    <div class="offcanvas-widget-area">
                        <ul>
                            ...
                            <li>
                                ...
                                <a href="mailto:info@yourdomain.com">info@cheparo.com</a>
                            </li>
                        </ul>
                    </div>
                </div>
