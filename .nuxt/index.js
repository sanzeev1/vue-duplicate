...
import nuxt_plugin_plugin_52a57f20 from 'nuxt_plugin_plugin_52a57f20' // Source: .\\components\\plugin.js (mode: 'all')
import nuxt_plugin_axios_766ab97a from 'nuxt_plugin_axios_766ab97a' // Source: .\\axios.js (mode: 'all')
...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"title":"Fancy - Online shopping","titleTemplate":"Fancy | %s","meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":""}],"link":[{"rel":"icon","type":"image\u002Fx-icon","href":"\u002Ffavicon.ico"}],"style":[],"script":[]},
  ...
  if (typeof nuxt_plugin_plugin_52a57f20 === 'function') {
    await nuxt_plugin_plugin_52a57f20(app.context, inject)
  }

  if (typeof nuxt_plugin_axios_766ab97a === 'function') {
    await nuxt_plugin_axios_766ab97a(app.context, inject)
  }
