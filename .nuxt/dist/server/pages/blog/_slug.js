...
/* harmony default export */ var BlogSidebarvue_type_script_lang_js = ({});
// CONCATENATED MODULE: ./components/BlogSidebar.vue?vue&type=script&lang=js
 /* harmony default export */ var components_BlogSidebarvue_type_script_lang_js = (BlogSidebarvue_type_script_lang_js); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(2);
...
var component = Object(componentNormalizer["a" /* default */])(
  components_BlogSidebarvue_type_script_lang_js,
  render,
  staticRenderFns,
  false,
  null,
...
var blog = __webpack_require__(61);
...
/* harmony default export */ var _slugvue_type_script_lang_js = ({data(){return{blog: blog,slug:this.$route.params.slug};},mounted(){this.blog=blog.find(blog=>this.slugify(blog.title)===this.slug);},methods:{slugify(text){return text.toString().toLowerCase().replace(/\s+/g,"-")// Replace spaces with -
...
/* nuxt-component-imports */
installComponents(component, {HeaderWithTopbar: __webpack_require__(51).default,Breadcrumb: __webpack_require__(52).default,BlogSidebar: __webpack_require__(74).default,TheFooter: __webpack_require__(50).default})
