...
/* harmony default export */ var TheHeadervue_type_script_lang_js = ({components:{Navigation:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 20)),MiniCart:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 18))},computed:{cartItemCount(){return this.$store.getters.cartItemCount;},wishlistItemCount(){return this.$store.getters.wishlistItemCount;}},data(){return{logginned:false,isSticky:false,isOpenSearch:false,isOpenAccountSettings:false,openCart:false,navOpen:false};},methods:{setSearch(e){this.searchValue=e.target.value;},search(e){e.preventDefault();window.location="/shop?search="+this.searchValue;}},mounted(){const user=localStorage.getItem('user');if(user)this.logginned=true;window.addEventListener("scroll",()=>{let scroll=window.scrollY;if(scroll>=200){this.isSticky=true;}else{this.isSticky=false;}});}});
// CONCATENATED MODULE: ./components/TheHeader.vue?vue&type=script&lang=js
 /* harmony default export */ var components_TheHeadervue_type_script_lang_js = (TheHeadervue_type_script_lang_js); 
...
var component = Object(componentNormalizer["a" /* default */])(
  components_TheHeadervue_type_script_lang_js,
  render,
  staticRenderFns,
  false,
  null,
