                ...
                <tbody>
                  <tr v-for="(product, index) in products" :key="index">
                    <td class="product-thumbnail">
                      <n-link :to="`/product/${slugify(product.product_name)}`">
                        <img
                          :src="`https://api.cheparo.com/${product.image}`"
                    ...
                    <td class="product-remove">
                      <button @click="removeProductFromWishlist(product)">
