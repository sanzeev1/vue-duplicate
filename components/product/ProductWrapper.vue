<template>
  <div>
    <div class="product-area pb-90">
      <div class="container">
        ...
        <ul class="nav product-tab-list pt-30 pb-55 justify-content-center" v-if="$store.state.categories.length > 0">
          <li class="nav-item" role="presentation" v-if="$store.state.categories[0]"
    ...
    <div class="product-area pb-90">
      <div class="container">
        <div>
          <!--  v-if="$store.state.categories[1] != null"  -->
        ...
        <ul class="nav product-tab-list pt-30 pb-55 justify-content-center" v-if="$store.state.categories.length > 0">
          <li class="nav-item" role="presentation" v-if="$store.state.categories[1]"
